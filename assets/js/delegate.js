$(document).ready(function(){
    ...
    if(address!=""){
        ...
        $('#staking_address').html('<a href="'+explorerURL+'address/'+contractAddress+'/contracts">'+contractAddress+'</a>');
        async function init(){
            ...
            var delegatorsData = "";
            $('#validator_address').html('<a href="'+explorerURL+'address/'+address+'/transactions">'+address+'</a>');
